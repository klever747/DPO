...
/** Descarga un archivo protegido por JWT y lo abre/descarga en una pestaña nueva. */
...
/** Decodifica el JWT propio (sin verificar firma, solo lectura local) para saber quién es el usuario actual. */
