...
/**
 * Módulo "Formación" — esqueleto funcional conectado a su propio
 * microservicio (/formaciones vía el API Gateway). Lista los registros
...
export default function Module() {
  ...
  useEffect(() => {
    apiFetch<{ data: Record<string, unknown>[] }>('/formaciones')
    ...
    <div className="dpo-module">
      ...
      {items.length === 0 && !error && (
        <div className="dpo-placeholder">
          <p>Aún no hay registros de "Formación".</p>
          <p>Este módulo ya está conectado a su microservicio (`/formaciones`) y listo para ampliarse con formularios de alta y edición.</p>
        </div>
      )}
