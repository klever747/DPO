...
/**
 * Módulo "Canal Ético" — esqueleto funcional conectado a su propio
 * microservicio (/denuncias vía el API Gateway). Lista los registros
...
export default function Module() {
  ...
  useEffect(() => {
    apiFetch<{ data: Record<string, unknown>[] }>('/denuncias')
    ...
    <div className="dpo-module">
      ...
      {items.length === 0 && !error && (
        <div className="dpo-placeholder">
          <p>Aún no hay registros de "Canal Ético".</p>
          <p>Este módulo ya está conectado a su microservicio (`/denuncias`) y listo para ampliarse con formularios de alta y edición.</p>
        </div>
      )}
