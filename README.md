...
├── services/               # 14 microservicios + gateway-api (NestJS)
├── frontend/
...
- los 14 microservicios + `gateway-api` (puertos 3000-3014),
- el `shell` y los 14 módulos frontend, cada uno en su propio contenedor
...
- Arquitectura completa: 14 microservicios + gateway, 14 módulos frontend + shell.
